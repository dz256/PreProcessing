function [all_roi,iteration] = SimonROI(I,fibatGlobalParam)


%% ACSAT Automated Cell Segmentation by Adaptive Thresholding
% 
%   Inputs:  - "I" max minus min image of the video stack
%            - free parameters which can be set below
%   Outputs: - "all_roi" which contains the segmented ROIs
%            - "iterationiteration" which contains intermediates during each
%               iteration of ACSAT
% 
...
%% Free parameters
    ...
    %TODO: handle case where partial fibatGlobalParam is given
